...
network_server:
python py_demo_server_lon.py --sut-server http://t004-005:8888 --dataset=coco-1024 --dataset-path=/work1/zixian/ziw081/inference/text_to_image/coco2014 --profile=stable-diffusion-xl-pytorch --dtype=fp16 --device=cuda --time=30 --scenario=Offline --max-batchsize=4
```
