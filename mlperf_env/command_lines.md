...
python main.py  --dataset=coco-1024 --dataset-path=/home/ziw081/inference/text_to_image/coco2014 --profile=stable-diffusion-xl-pytorch --dtype=fp16 --device=cuda --time=30 --scenario=Offline 
```
